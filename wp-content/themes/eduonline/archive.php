				...
				switch ($jws_theme_blog_layout) {
					...
					case '2cl':
						if(is_active_sidebar( 'tbtheme-right-sidebar' )){
							$cl_content = 'col-xs-12 col-sm-12 col-md-9 col-lg-9 has-sidebar';
							$cl_sb_left = 'col-xs-12 col-sm-12 col-md-3 col-lg-3';
						}
						break;
					case '2cr':
						if(is_active_sidebar( 'tbtheme-right-sidebar' )){
							$cl_content = 'col-xs-12 col-sm-12 col-md-9 col-lg-9 has-sidebar';
							$cl_sb_right = 'col-xs-12 col-sm-12 col-md-3 col-lg-3';
						}
						break;
				}
				?>
					...
					if( have_posts() ) {
						...
						switch ($columns) {
							...
							case 3: $class_columns = 'col-xs-12 col-sm-6 col-md-4 col-lg-4';
								break;
							case 4: $class_columns = 'col-xs-12 col-sm-6 col-md-4 col-lg-3';
								break;
							default: $class_columns = 'col-xs-12 col-sm-6 col-md-4 col-lg-3';
								break;
						}
