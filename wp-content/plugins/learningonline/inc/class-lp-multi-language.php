...
if ( !class_exists( 'LP_Multi_Language' ) ) {
	...
	class LP_Multi_Language {
		public static function init() {
			...
			$plugin = 'learningonline/learningonline.php';
...
if ( !function_exists( 'learning_online_load_plugin_text_domain' ) ) {
	/**
	 ...
	 * @param        mixed
	 */
	function learning_online_load_plugin_text_domain( $path, $text_domain = true ) {
