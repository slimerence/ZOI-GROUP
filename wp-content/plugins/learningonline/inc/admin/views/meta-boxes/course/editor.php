<script type="text/html" id="tmpl-course-editor">
	<div id="learning-online-course-editor" class="course-editor">
		<div id="course-item-editor"></div>
		<div id="course-curriculum">

		</div>
		<button class="button button-add-section" type="button"><?php esc_html_e( 'Add Section', 'learningonline' ); ?></button>
	</div>
</script>
...
<script type="text/html" id="tmpl-course-section">
	<div class="course-section" data-section_id="{{data.section_id}}" data-temp_id="{{data.temp_id}}">
		...
		<div class="section-head">
			<input type="text" class="section-name" name="LP[section][{{data.temp_id}}][title]" placeholder="<?php esc_attr_e( 'New section title', 'learningonline' ); ?>" value="{{data.section_name}}" />
			<span class="section-move"></span>
			<div class="course-row-actions">
				<a class="remove" data-action="remove" href=""><?php esc_html_e( 'Remove', 'learningonline' ); ?></a>
				<a class="add" data-action="add" href=""><?php esc_html_e( 'Add', 'learningonline' ); ?></a>
		...
		<div class="section-body">
			...
			<div class="section-add-content">
				<ul class="section-content-types">
					<li class="dashicons dashicons-clock" data-post_type="lp_quiz" data-post_title="<?php esc_attr_e( 'New quiz name', 'learningonline' ); ?>"></li>
					<li class="dashicons dashicons-media-default" data-post_type="lp_lesson" data-post_title="<?php esc_attr_e( 'New lesson name', 'learningonline' ); ?>"></li>
				</ul>
				<button class="button button-add-content"><?php esc_html_e( 'Add Content', 'learningonline' ); ?></button>
				<button class="button button-add-exists-content"><?php esc_html_e( 'Add Existing Content', 'learningonline' ); ?></button>
			</div>
		</div>
	</div>
</script>
...
<script type="text/html" id="tmpl-course-section-item">
	<li class="course-section-item" data-ID="{{data.ID}}" data-temp_id="{{data.temp_id}}">
		...
		<input type="text" class="item-name" name="LP[section][{{data.section.temp_id}}][items][{{data.temp_id}}][title]" placeholder="<?php esc_attr_e( 'New item title', 'learningonline' ); ?>" value="{{data.post_title}}">
		<span class="section-item-move"></span>
		<div class="course-row-actions ">
			<a class="remove" data-action="remove-item" href=""><?php esc_html_e( 'Remove', 'learningonline' ); ?></a>
			<a class="quick-edit" data-action="quick-edit" href=""><?php esc_html_e( 'Quick edit', 'learningonline' ); ?></a>
		</div>
	</li>
</script>
...
<script type="text/html" id="tmpl-course-item-editor">
	<div class="course-item-editor">
		<ul>
			<li>
				<h3><?php esc_html_e( 'Title', 'learningonline' ); ?></th></h3>
				<input type="text" class="regular-text" value="{{data.post_title}}" />
			</li>
			<li>
				<h3><?php esc_html_e( 'Content', 'learningonline' ); ?></h3>
				<#
