...
?>
<h3><?php _e( 'New order customer', 'learningonline' ); ?></h3>
<p class="description">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <input id="learning-online-emails-new-order-enable" type="checkbox" name="<?php echo $settings_class->get_field_name( 'emails_new_order_customer[enable]' ); ?>" value="yes" <?php checked( $settings->get( 'emails_new_order_customer.enable' ), 'yes' ); ?> />
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                ...
                <input id="learning-online-emails-new-order-subject" class="regular-text" type="text" name="<?php echo $settings_class->get_field_name( 'emails_new_order_customer[subject]' ); ?>" value="<?php echo $settings->get( 'emails_new_order_customer.subject', $default ); ?>" />
        ...
        <tr>
            ...
            <td>
                ...
                <input id="learning-online-emails-new-order-heading" class="regular-text" type="text" name="<?php echo $settings_class->get_field_name( 'emails_new_order_customer[heading]' ); ?>" value="<?php echo $settings->get( 'emails_new_order_customer.heading', $default ); ?>" />
        ...
        <tr>
            ...
            <td>
                <?php learning_online_email_formats_dropdown( array( 'name' => $settings_class->get_field_name( 'emails_new_order_customer[email_format]' ), 'id' => 'learning_online_email_formats', 'selected' => $settings->get( 'emails_new_order_customer.email_format', $default ) ) ); ?>
            </td>
        </tr>
        -->
        <?php
