...
class LP_Lesson extends LP_Abstract_Course_Item {
	...
	public function is_previewable() {
		return apply_filters( 'learning_online_lesson_preview', ($this->preview == 1||$this->preview === 'yes'), $this );
	}
	...
	private static function get_lesson_class( $the_lesson, $args = array() ) {
		...
		return apply_filters( 'learning_online_lesson_class', $class_name, $lesson_type, $post_type, $lesson_id );
	}
	...
	private static function get_lesson_object( $the_lesson ) {
		...
		return apply_filters( 'learning_online_lesson_object', $the_lesson );
	}
