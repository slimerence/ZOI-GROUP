...
class LP_Debug {
	...
	private function open( $handle ) {
		...
		$path = learning_online_get_log_file_path( $handle );
		$f    = @fopen( $path, 'a' );
	...
	public function add( $message, $handle = 'log', $clear = false ) {
		...
		do_action( 'learning_online_log_add', $handle, $message );
	}
	...
	public function clear( $handle ) {
		...
		do_action( 'learning_online_log_clear', $handle );
	}
