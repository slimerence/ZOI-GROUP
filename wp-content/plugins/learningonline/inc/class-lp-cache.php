 ...
 * Class LP_Cache
 *
 * Cache helper using functions of WP Cache with default group is learningonline
 *
 * @since 1.1
 */
if ( !defined( 'ABSPATH' ) ) {
...
class LP_Cache {
	 ...
	 * @var string
	 */
	protected static $_group = 'learningonline';
	 ...
	 * @return mixed
	 */
	public static function set( $key, $value, $expire = 0, $group = 'learningonline' ) {
	 ...
	 * @return bool|mixed
	 */
	public static function get( $key, $force = false, &$found = 0, $group = 'learningonline' ) {
