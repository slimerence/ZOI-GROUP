...
if ( !class_exists( 'LP_Email_Published_Course' ) ) {
	...
	class LP_Email_Published_Course extends LP_Email {
		...
		public function __construct() {
			...
			$this->title = __( 'Approved course', 'learningonline' );

			$this->template_html  = 'emails/published-course.php';
			$this->template_plain = 'emails/plain/published-course.php';

			$this->default_subject = __( '[{{site_title}}] Your course {{course_name}} has been approved', 'learningonline' );
			$this->default_heading = __( 'Course approved', 'learningonline' );
		...
		public function admin_options( $settings_class ) {
			$view = learning_online_get_admin_view( 'settings/emails/published-course.php' );
			include_once $view;
		}
