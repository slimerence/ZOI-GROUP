...
(function ($) {
	...
	LP.MessageBox = {
		...
		quickConfirm   : function (elem, args) {
			...
			!$e.attr("learning-online-quick-confirm") && $e.attr("learning-online-quick-confirm", "true").data("quick-confirm", new (function (elem, args) {
				var $elem = $(elem), $div = $('<span class="learning-online-quick-confirm"></span>').insertAfter($elem), offset = $(elem).position() || {
						left: 0,
						top : 0
	...
	LP = $.extend({
		setUrl           : function (url, title) {
			...
			var type = args.type || "post", dataType = args.dataType || "json", action = ((args.prefix == undefined) || "learningonline_") + args.action, data = args.action ? $.extend(args.data, {action: action}) : args.data;
			$.ajax({
				data    : data,
