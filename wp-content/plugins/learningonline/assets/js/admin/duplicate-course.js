...
( function ( $, _, Backbone ) {
    ...
    var LP_Course_Duplicator = window.LP_Course_Duplicator = Backbone.View.extend( {
        el: 'learning-online-duplicate-course',
        tagName: 'div',
        template: null,
        course_id: null,
        course_title: null,
        ...
        render: function() {
            var _this = this;
            this.template = wp.template( 'learning-online-duplicate-course' )({
            ...
            this.setElement($('#learning-online-message-box-window'));
            this.delegateEvents();
            $( '.learning-online-tooltip' ).tooltip({offset: [50, -30]});
        },
        ...
        _duplicate: function( e ) {
            ...
            var _this = $( e.currentTarget ),
                    ...
                    data = {
                        course_id: id,
                        _nonce: nonce,
                        action: 'learningonline_duplicate_course'
                    },
                    buttons = _this.parents( '#learning-online-duplicate-course' ).find( 'button' );
