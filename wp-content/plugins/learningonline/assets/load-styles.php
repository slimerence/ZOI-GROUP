...
if ( !defined( 'ABSPATH' ) ) {
	define( 'ABSPATH', str_replace( LP_WP_CONTENT . '/plugins/learningonline/assets/load-styles.php', '', $_SERVER['SCRIPT_FILENAME'] ) );
}
define( 'WPINC', 'wp-includes' );
define( 'LP_PATH', '/' . LP_WP_CONTENT . '/plugins/learningonline/' );
...
foreach ( $load as $handle ) {
	...
	if ( strpos( $path, '/learningonline/assets/' ) !== false ) {
