...
$heading       = sprintf( __( 'Other results (newest %d items)', 'learningonline' ), $limit );
$heading       = apply_filters( 'learning_online_quiz_history_heading', $heading );
?>
...
if ( $history_count > 1 ) {
	...
	<div class="lp-group-content-wrap hide-if-js" id="lp-quiz-history">
		<table class="quiz-history">
			...
			<tr>
				...
				<th><?php _e( 'Time', 'learningonline' ); ?></th>
				<th><?php _e( 'Result', 'learningonline' ); ?></th>
			</tr>
			</thead>
	...
	learning_online_display_message( __( 'No history found!', 'learningonline' ) );
}