...
?>
<?php if ( false !== ( $title = apply_filters( 'learning_online_quiz_question_title', $question->get_title() ) ) ): ?>
	<h4 class="quiz-question-title"><?php echo $title; ?></h4>
<?php endif; ?>
<div class="quiz-question-content">
	<div method="post" name="quiz-question-content">
		<?php if ( false !== ( $content = apply_filters( 'learning_online_quiz_question_content', $question->get_content() ) ) ): ?>
		...
		?>
		<?php learning_online_get_template( 'content-question/hint.php', array( 'quiz' => $quiz ) ); ?>
	</div>
</div>
