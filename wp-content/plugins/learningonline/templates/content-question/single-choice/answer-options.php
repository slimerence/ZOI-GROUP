	...
	<ul class="learning-online-question-options">
		...
		foreach ( $answers as $k => $answer ):
			...
			<li<?php echo $answer_class ? ' class="' . join( ' ', $answer_class ) . '"' : ''; ?> >
				...
				<label>
					<input type="radio" name="learning-online-question-<?php echo $this->id; ?>" <?php checked( $this->is_selected_option( $answer, $answered ) ); ?> value="<?php echo $answer['value']; ?>" <?php echo $disabled; ?>>
