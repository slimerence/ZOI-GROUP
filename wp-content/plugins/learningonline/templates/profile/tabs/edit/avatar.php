...
$thumb_size   = learning_online_get_avatar_thumb_size();
	...
	<ul class="lp-form-field-wrap">
		<li class="lp-form-field">
			<div class="lp-form-field-input lp-form-field-avatar">
				...
				<button id="lp-upload-photo"><?php _e( 'Upload', 'learningonline' ); ?></button>
				<?php if ( $custom_img != '' ): ?>
					<button id="lp-remove-upload-photo"><?php _e( 'Remove', 'learningonline' ); ?></button>
				<?php endif; ?>
				</p>
			</div>
		</li>
