...
$curriculum_heading = apply_filters( 'learning_online_curriculum_heading', __( 'Course Curriculum', 'learningonline' ) );
?>
<div class="course-curriculum" id="learning-online-course-curriculum">
	...
	<?php else: ?>
		<?php echo apply_filters( 'learning_online_course_curriculum_empty', __( 'Curriculum is empty', 'learningonline' ) ); ?>
	<?php endif; ?>
