...
learning_online_get_template( 'single-course/header-content-item-only.php' );
$user   = learning_online_get_current_user();
$course = learning_online_get_the_course();
$item   = LP()->global['course-item'];
$data   = array(
	'messageType'          => 'update-course',
	'completed_items_text' => __( '%d of %d items', 'learningonline' ),
);
global $lp_query;
...
?>
	...
	<div class="learning-online-content-item-only">
		<?php learning_online_print_messages(); ?>
		<?php learning_online_get_template( 'single-course/content-item.php' ); ?>
	</div>
<?php ob_start(); ?>
	<script>
		...
		$(document).ready(function () {
			...
			LP.sendMessage(LP.Hook.applyFilters('learning_online_content_item_send_data', data, windowTarget), windowTarget);
...
learning_online_get_template( 'single-course/footer-content-item-only.php' );